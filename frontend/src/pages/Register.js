...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await register({ username, email, password, phone: phone || undefined });
        ...
        <div className="bg-dark-900 rounded-xl border border-dark-700 p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full py-3 px-4 bg-white text-gray-800 rounded-lg font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center gap-3 shadow-sm"
            >
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-gray-800 text-white rounded-lg font-semibold hover:bg-gray-700 transition-colors flex items-center justify-center gap-3 border border-gray-600"
            >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-dark-900 text-dark-400">or register with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-dark-300 mb-2">Phone Number <span className="text-dark-500">(optional)</span></label>
              <input
                type="tel"
                value={phone}
